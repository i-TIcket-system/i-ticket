...
.cover-page {
  position: relative;
  width: 100%;
  height: 274mm;          /* 297mm − 38px header − 38px footer ≈ 277mm, with 3mm buffer */
  overflow: hidden;
...
/* ─── CONTENT PAGES ──────────────────────────────────────────────── */
.content {
  padding-top: 18mm;    /* replaces removed @page top margin (14mm) + original 4mm pad */
  padding-bottom: 16mm; /* replaces removed @page bottom margin */
}
...
@media print {
  ...
  @page { size: A4; margin: 0mm 20mm 0mm 20mm; } /* vertical margins moved to .content padding */
