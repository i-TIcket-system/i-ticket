...
export default function PlatformStaffPage() {
  ...
  const getStatusBadge = (status: string) => {
    const variants: Record<string, any> = {
      ...
      ON_LEAVE: <Badge className="bg-yellow-100 text-yellow-800"><Clock className="h-3 w-3 mr-1" />On Leave</Badge>,
      SUSPENDED: <Badge className="bg-orange-100 text-orange-800"><Ban className="h-3 w-3 mr-1" />Suspended</Badge>,
      TERMINATED: <Badge className="bg-red-100 text-red-800"><XCircle className="h-3 w-3 mr-1" />Terminated</Badge>,
    }
